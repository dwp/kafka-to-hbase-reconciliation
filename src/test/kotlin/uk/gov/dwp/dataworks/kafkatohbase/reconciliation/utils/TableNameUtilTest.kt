...
//
//        whenever(hbaseConfig.qualifiedTablePattern()).thenReturn("""^\w+\.([-\w]+)\.([-\w]+)$""")
...
//
//        verify(hbaseConfig, times(1)).qualifiedTablePattern()
...
//
//        whenever(hbaseConfig.qualifiedTablePattern()).thenReturn("""([-\w]+)\.([-\w]+)""")
